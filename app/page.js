        ...
        <div className="max-w-3xl mx-auto bg-black bg-opacity-70 p-8 rounded-lg">
          ...
          <ol className="list-decimal list-inside mb-4 pl-4">
            <li className="mb-2">
              ...
              <p className="mt-2">The sacred act of self-restraint. To {'"jeet"'} is to indulge in unholy cravings, giving in to fleeting pleasures. The Holy Babababible teaches that eternal joy comes not from overindulgence but from following the Minion way of balance and harmony. A true disciple of the Minions must remain pure, resisting all temptations to jeet.</p>
            </li>
            <li className="mb-2">
              <strong>Never Goon</strong>
              <p className="mt-2">To {'"goon"'} is to forsake the path of enlightenment, surrendering to chaos and distraction. The Babababible implores us to stay focused, centered on our faith in Jesus Minion and His divine wisdom. Those who goon risk wandering from the banana-lined road to salvation.</p>
            </li>
          </ol>
